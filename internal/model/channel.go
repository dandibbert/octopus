...
type Channel struct {
	...
	ModelWrappers         []string              `json:"model_wrappers,omitempty" gorm:"serializer:json"`
	BillingBasis          BillingBasis          `json:"billing_basis" gorm:"size:32;not null;default:'actual'"`
	BillingClass          string                `json:"billing_class_id,omitempty" gorm:"size:255"`
	BillingUnknownPolicy  UnknownPricePolicy    `json:"billing_unknown_policy" gorm:"size:32;not null;default:'use_routed'"`
	ProviderUnknownPolicy UnknownPricePolicy    `json:"provider_unknown_policy" gorm:"size:32;not null;default:'use_routed'"`
...
type ChannelUpdateRequest struct {
	...
	ModelWrappers         *[]string              `json:"model_wrappers,omitempty"`
	BillingBasis          *BillingBasis          `json:"billing_basis,omitempty"`
	BillingClass          *string                `json:"billing_class_id,omitempty"`
	BillingUnknownPolicy  *UnknownPricePolicy    `json:"billing_unknown_policy,omitempty"`
	ProviderUnknownPolicy *UnknownPricePolicy    `json:"provider_unknown_policy,omitempty"`
