    ...
    return useQuery({
        ...
        select: (data): APIKeyStatsResponseFormatted => ({
            stats: {
                ...
                provider_cost: formatMoney((data.stats.provider_input_cost ?? 0) + (data.stats.provider_output_cost ?? 0)),
                unknown_price_requests: formatCount(data.stats.unknown_price_requests ?? 0),
                route_fallback_requests: formatCount(data.stats.route_fallback_requests ?? 0),
                model_mismatch_requests: formatCount(data.stats.model_mismatch_requests ?? 0),
