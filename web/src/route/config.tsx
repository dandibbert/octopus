...
import { Home, Radio, Sparkles, FolderTree, Settings, Logs, Globe2, MessageSquareText } from 'lucide-react';
...
const Playground_Module = lazyWithPreload(() => import('@/components/modules/playground').then(m => ({ default: m.Playground })));
