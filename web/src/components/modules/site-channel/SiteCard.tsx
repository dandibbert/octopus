                        ...
                        <header className="flex flex-wrap items-center justify-between gap-3">
                            ...
                            <div className="flex w-full shrink-0 flex-wrap items-center justify-start gap-2 md:w-auto md:justify-end">
                                <Badge variant="outline" className="h-6 px-2 text-2xs">
                                    {platformLabel(card.platform, tSite)}
                                </Badge>
                        ...
                        {summary.routeCounts.size > 0 ? (
                            <div className="flex flex-1 flex-wrap content-center gap-2">
                                {SITE_ROUTE_DISPLAY_ORDER.filter((routeType) => (summary.routeCounts.get(routeType) ?? 0) > 0).map((routeType) => (
                                    <Badge key={routeType} variant="outline" className={cn('h-6 shrink-0 px-2 text-2xs', getRouteTypeTone(routeType))}>
                                        {SHORT_ROUTE_LABEL[routeType] ?? routeTypeLabel(routeType, tSite)}
